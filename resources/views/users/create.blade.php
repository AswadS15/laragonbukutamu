...
<div class=" h-screen sm:ml-64 bg-white  overflow-auto py-5 pt-16 font-popins">
    ...
    <div class="mt-20 w-[90%] mx-auto">
        <div class="max-w-sm w-full rounded-lg shadow-md border p-3  mx-auto">
            <h1 class="py-2 text-center text-xl font-semibold text-emerald-400 border-b-2 mb-2">Form Tambah User</h1>
            <div class="px-3">
                <form class="mt-8 space-y-5" method="POST" action="/users">
                    @csrf
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="name" id="name" class=" font-popins font-normal block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " required value="{{ old('name') }}"/> 
                    ...
                    <label for="role" class=" font-popins font-normal block mb-2 text-lg text-gray-500">Role</label>
